...
class AuditEvent:
    ...
    MERIT_INCREASE_RATE_UPDATED = "MERIT_INCREASE_RATE_UPDATED"
    COMPENSATION_BURDEN_RATE_UPDATED = "COMPENSATION_BURDEN_RATE_UPDATED"
    COMPENSATION_MAPPING_UPDATED = "COMPENSATION_MAPPING_UPDATED"
    OVERHEAD_RATE_CREATED = "OVERHEAD_RATE_CREATED"
    OVERHEAD_RATE_UPDATED = "OVERHEAD_RATE_UPDATED"
    OVERHEAD_RATE_DEACTIVATED = "OVERHEAD_RATE_DEACTIVATED"
